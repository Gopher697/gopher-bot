...
### 5d-chess-with-multiverse-time-travel-agent-workspace

- Root: `D:\SteamLibrary\steamapps\common\5dchesswithmultiversetimetravel\agent-workspace`
- Configured summary/entry file: `CURRENT_SESSION.md`
- Actual first file to read: `SAFETY_RULES.md`, then `CURRENT_SESSION.md`, `GOALS.md`, and `WORLD_STATE.md`.
- Current authority status: Registered game-specific agent memory workspace for 5D Chess With Multiverse Time Travel.
- Related external notes/spaces: Core game-agent doctrine in `D:\GameAgentCore`
- Historical/reference/staging areas: `notes\sessions\`
- Project-specific warnings: Never modify files inside the game installation directory other than those inside `agent-workspace\`; avoid unrequested story spoilers.
- Open authority questions: None identified beyond normal session-note promotion rules.

### distant-worlds-universe-agent-workspace

- Root: `D:\SteamLibrary\steamapps\common\Distant Worlds Universe\agent-workspace`
- Configured summary/entry file: `CURRENT_SESSION.md`
- Actual first file to read: `SAFETY_RULES.md`, then `CURRENT_SESSION.md`, `GOALS.md`, and `WORLD_STATE.md`.
- Current authority status: Registered game-specific agent memory workspace for Distant Worlds: Universe.
- Related external notes/spaces: Core game-agent doctrine in `D:\GameAgentCore`
- Historical/reference/staging areas: `notes\sessions\`
- Project-specific warnings: Never modify files inside the game installation directory other than those inside `agent-workspace\`; avoid unrequested story spoilers.
- Open authority questions: None identified beyond normal session-note promotion rules.

### factorio-agent-workspace

- Root: `D:\SteamLibrary\steamapps\common\Factorio\agent-workspace`
- Configured summary/entry file: `CURRENT_SESSION.md`
- Actual first file to read: `SAFETY_RULES.md`, then `CURRENT_SESSION.md`, `GOALS.md`, and `WORLD_STATE.md`.
- Current authority status: Registered game-specific agent memory workspace for Factorio.
- Related external notes/spaces: Core game-agent doctrine in `D:\GameAgentCore`
- Historical/reference/staging areas: `notes\sessions\`
- Project-specific warnings: Never modify files inside the game installation directory other than those inside `agent-workspace\`; avoid unrequested story spoilers.
- Open authority questions: None identified beyond normal session-note promotion rules.

### elemental-reforged-agent-workspace

- Root: `D:\SteamLibrary\steamapps\common\Elemental Reforged\agent-workspace`
- Configured summary/entry file: `CURRENT_SESSION.md`
- Actual first file to read: `SAFETY_RULES.md`, then `CURRENT_SESSION.md`, `GOALS.md`, and `WORLD_STATE.md`.
- Current authority status: Registered game-specific agent memory workspace for Elemental Reforged.
- Related external notes/spaces: Core game-agent doctrine in `D:\GameAgentCore`
- Historical/reference/staging areas: `notes\sessions\`
- Project-specific warnings: Never modify files inside the game installation directory other than those inside `agent-workspace\`; avoid unrequested story spoilers.
- Open authority questions: None identified beyond normal session-note promotion rules.
...
### amazing-cultivation-simulator-agent-workspace

- Root: `D:\SteamLibrary\steamapps\common\AmazingCultivationSimulator\agent-workspace`
- Configured summary/entry file: `CURRENT_SESSION.md`
- Actual first file to read: `SAFETY_RULES.md`, then `CURRENT_SESSION.md`, `GOALS.md`, and `WORLD_STATE.md`.
- Current authority status: Registered game-specific agent memory workspace for Amazing Cultivation Simulator.
- Related external notes/spaces: Core game-agent doctrine in `D:\GameAgentCore`
- Historical/reference/staging areas: `notes\sessions\`
- Project-specific warnings: Never modify files inside the game installation directory other than those inside `agent-workspace\`; avoid unrequested story spoilers.
- Open authority questions: None identified beyond normal session-note promotion rules.
